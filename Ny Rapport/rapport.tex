...
\begin{algorithm}[H]
  \For{varje partikel $i$}{
    \If{partikeln befinner sig under kollisionsplanet:}{
      ...
      \item Multiplicara den komponent av hastighetsvektorn som är ortogonal med\\ kollisionsplanet med en elasticitetskoefficient, se Figur \ref{kol4}.\
    \end{itemize}
    }
  }
\caption{Kollisionshantering\label{IR}}
\end{algorithm}
...
\caption{Algoritm baserad på massorna\label{IR}}
\end{algorithm}
...
\caption{Algoritm baserad på kopplingarna mellan massorna\label{IR}}
\end{algorithm}
