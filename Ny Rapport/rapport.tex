...
\begin{figure}[h!]
  ...
  \label{2D_simple}
\end{figure}
I MATLAB utvecklades först ett MSD-system i en dimension, där partiklar sammankopplades i serie enligt Figur \ref{simple1D2} nedan.

\begin{figure}[h!]
  \begin{center}
    \includegraphics[width=6cm]{Bilder/simple1D2.png} 
  \end{center}
