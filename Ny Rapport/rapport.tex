...
\end{figure}
\\Klassen MCS (Mass Connection System) är den klass som lagrar all huvudsaklig data. Den innehåller samtliga partiklar och kopplingar för ett system vilka definieras av information enligt nedan.
\\\\
\begin{tabular}{|r l | r l|}
\hline
 & Kopplingar & & Partiklar\\
\hline
l & vilolängd & p & position \\
k & fjäderkonstant & v & hastighet\\
b & dämparkonstant & a & acceleration\\
p1 & index till den ena partikeln & F & total momentan kraftpåverkan\\
p2 & index till den andra partikel & m & massa\\
\hline
\end{tabular}
\\\\
Vad som också framgår i Figur \ref{systemark} är att all numerisk integrering beräknas i en separat modul vilket gjorde det enkelt att ändra integreringsmetod vid behov, då den var oberoende av resten av systemet.
