...
Att implementera kraftekvationen för varje massa i ett MSD-system enligt (KRAFTEKV), innebär att kraftvektorn till varje massa i beräknas. Med denna kraftvektor kan i sin tur accelerationen beräknas för varje massa enligt (DIFFEKV). I detta projekt undersöktes två algoritmer för detta ändamål.\\\\
